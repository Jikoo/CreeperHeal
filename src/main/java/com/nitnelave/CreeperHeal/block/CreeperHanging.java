...
public abstract class CreeperHanging implements Replaceable {
  ...
  /**
   * Constructor. The date is the time the hanging was destroyed, and fire is whether the hanging
   * was destroyed by fire, or an explosion.
   *
   * @param hanging The hanging destroyed.
   */
   ...
   *
   * @param hanging The hanging to be represented by the Object.
   * @return An instance of the right subclass of CreeperHanging.
   */
  public static CreeperHanging newHanging(Hanging hanging) {
    if (hanging.getType() == EntityType.PAINTING) return new CreeperPainting((Painting) hanging);
  ...
  /**
   * Get the location of the painting, so that it is right in front of the block it should be
   * attached to.
   *
