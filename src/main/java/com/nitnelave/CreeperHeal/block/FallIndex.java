...
public class FallIndex {
  ...
  static {
    Bukkit.getScheduler()
        .scheduleSyncRepeatingTask(CreeperHeal.getInstance(), FallIndex::cleanUp, 400, 7200);
  }
  ...
  /**
   * Add the location to the list of blocks that shouldn't fall. The block's fall is prevented until
   * after 200 times the block per block replacement interval.
   *
