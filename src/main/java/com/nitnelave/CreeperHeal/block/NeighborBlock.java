...
public class NeighborBlock {
   ...
   * Constructor.
   *
   * @param block The block represented, the one that is possibly dependent.
   * @param face The BlockFace with which it was obtained.
   */
  ...
  /**
   * Check if the represented block is a dependent block and that it's dependent face matches the
   * one defined in the constructor.
   *
   * @return Whether this block depends on the block provided in the constructor.
   */
