...
public class CreeperBlockListener implements Listener {
  ...
  /**
   * Listener for the BlockBurntEvent. If appropriate, the block is recorded for future replacement.
   *
   * @param event The BlockBurntEvent.
   */
  ...
  public void onBlockBurn(BlockBurnEvent event) {
    ...
    if (world.getBool(WCfgVal.FIRE)
        && !world.isProtected(event.getBlock())
