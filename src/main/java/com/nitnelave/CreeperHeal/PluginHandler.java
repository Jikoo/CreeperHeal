...
public class PluginHandler {
  ...
  static {
    ...
    if (lwcp != null) lwc = ((LWCPlugin) lwcp).getLWC();

    if (detectPlugin("MobArena") != null) maHandler = new MobArenaHandler();
  }
  ...
  private static Plugin detectPlugin(String name) {
    ...
    if (plugin != null) CreeperLog.logInfo("Successfully hooked into " + name, 1);
    return plugin;
  }
